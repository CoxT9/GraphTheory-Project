...
\bibitem{treewidth-lowerbounds-1}
\bibitem{treewidth-lowerbounds-2}
\bibitem{treewidth-value-reduction}
\bibitem{bodlaender-not-recommended}
\bibitem{bodlaender-unsuccessful}
\bibitem{project-github}
\end{thebibliography}
